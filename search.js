...
var find = function(word1,body,callback){
   var count=0;
     var data =[];
...
var processword = function(word1,callback){
   initialspace(word1,function(word2){
       endspace(word2,callback);
   });
} ;
module.exports ={processword,find};
